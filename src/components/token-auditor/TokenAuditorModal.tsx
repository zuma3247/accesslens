...
export function TokenAuditorModal({ isOpen, onClose }: TokenAuditorModalProps) {
  ...
  return (
    <div
      ref={modalRef}
      className="fixed inset-0 z-[9999] flex items-center justify-center bg-[var(--color-modal-overlay)] backdrop-blur-md p-4"
      onClick={handleOverlayClick}
      role="dialog"
      aria-modal="true"
      aria-labelledby="token-auditor-title"
    >
      <div className="w-full max-w-4xl max-h-[90vh] bg-[var(--color-modal-bg)] border-2 border-[hsl(var(--color-border-strong))] rounded-xl shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
